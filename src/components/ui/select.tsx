...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(selectTriggerStyles, svgStyles, className)}
      {...props}
    >
      {children}
...
function SelectItem({ className, children, ...props }: React.ComponentProps<typeof SelectPrimitive.Item>) {
  return (
    <SelectPrimitive.Item data-slot='select-item' className={cn(selectItemStyles, svgStyles, className)} {...props}>
