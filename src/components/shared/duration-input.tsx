    ...
    <div className="flex items-center gap-4 flex-wrap">
      <div className="flex flex-1 items-center gap-2">
        <Input
          ...
          onChange={(e) =>
            onChange?.(
              calculateTotalMinutes(parseInt(e.target.value) || 0, hours, minutes)
            )
          }
        />
      ...
      <div className="flex flex-1 items-center gap-2">
        <Input
          ...
          onChange={(e) =>
            onChange?.(
              calculateTotalMinutes(days, parseInt(e.target.value) || 0, minutes)
            )
          }
        />
      ...
      <div className="flex flex-1 items-center gap-2">
        <Input
          ...
          onChange={(e) =>
            onChange?.(
              calculateTotalMinutes(days, hours, parseInt(e.target.value) || 0)
            )
          }
        />
